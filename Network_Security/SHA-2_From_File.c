...
void read_message_from_file(const char *filename, char *message, size_t max_length)
{
    ...
    if (fgets(message, max_length, file) == NULL) {
...
int main() {
    ...
    read_message_from_file("message.txt", message, sizeof(message));
